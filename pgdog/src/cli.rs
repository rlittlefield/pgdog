...
pub(crate) enum Commands {
    ...
    /// in the config but still pending, and activate it.
    AddShard {
        /// Database gaining a shard.
        #[arg(long)]
        database: String,

        /// The shard to add: one of the database's pending
...
pub(crate) async fn move_keys(commands: Commands) -> Result<(), Box<dyn std::error::Error>> {
