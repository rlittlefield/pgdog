...
//! [`AddShardTask`]: provision the named shard, declared in the config
//! but still pending — schema, omnisharded data, logical-replication
//! catch-up — and activate it, on
...
impl Command for AddShard {
    ...
    async fn execute(&self) -> Result<Vec<Message>, Error> {
        ...
        // database, schema_admin user, or pending entry; the
